...
const PostForm = ({ postForm, pid, forNewTool = true }) => {
  ...
  return (
    <div className="col-4 d-flex justify-content-start">
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <label htmlFor="damagePrice" className="form-label">
        ...
        <div className="mb-3">
          ...
          >
            ...
            <option value="Aerial Work Platforms, Ladders & Scaffolding">
              Aerial Work Platforms, Ladders & Scaffolding
            </option>
            <option value="Air Compressors & Air Tools">
            ...
            <option value="Generators & Light Towers">
              Generators & Light Towers
            </option>
            <option value="Heaters & Propane Equipment">
              Heaters & Propane Equipment
            </option>
            <option value="Home Remodeling & Floor Care">
              Home Remodeling & Floor Care
            </option>
            <option value="Jacks & Material Handling">
              Jacks & Material Handling
            </option>
            <option value="Lawn Equipment">Lawn Equipment</option>
            <option value="Moving Equipment">Moving Equipment</option>
            <option value="Plumbing Tools & Sewer Equipment">
              Plumbing Tools & Sewer Equipment
            </option>
            <option value="Pressure Washer & Auto Scrubbers">
              Pressure Washer & Auto Scrubbers
            </option>
            <option value="Surface Preparation">Surface Preparation</option>
            <option value="Trucks & Trailers Equipment">
              Trucks & Trailers
            </option>
            <option value="Vacuums, Blowers & Air Filtration">
              Vacuums, Blowers & Air Filtration
            </option>
